...
class StrategyEngine:
    ...
    def detect_trade_signal(self) -> Optional[Dict]:
        ...
        try:
            ...
            # ✅ Volume: compare last fully closed candle with avg of 50 before that
            avg_volume = df['volume'].iloc[-52:-2].mean()  # candles [-52 to -2]
            last_volume = df['volume'].iloc[-2]            # candle -2
