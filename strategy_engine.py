...
# Risk reward config - You can adjust here or import from config.py
RISK_REWARD = 1.5
...
class Bollinger15MinLiveStrategy:
        ...
        if self.position == 0:
            if current['close'] < current['lower'] and prev['close'] >= prev['lower']:
                signal = {
                    ...
                    "confidence": 0.75  # Example confidence, you can improve logic
                }
    ...
    def process_signal(self, signal):
        ...
        # Save signal to JSON only if entry signal
