...
class StrategyEngine:
    ...
    def detect_trade_signal(self) -> Optional[Dict]:
        ...
        try:
            ...
            # ✅ Use 200 previous candles excluding current
            ...
            logging.info(
                f"[DEBUG] Prediction: {prediction:.2f}, Volume OK: {volume_ok}, "
                f"Trend Up: {trend_up}, Trend Down: {trend_down}, "
                f"Close > Prev High: {last_row['close'] > prev_row['high']}, "
                f"Close < Prev Low: {last_row['close'] < prev_row['low']}"
            )
