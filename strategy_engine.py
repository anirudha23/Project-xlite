...
class SMC_BOS_FVG_Strategy:
    ...
    def detect_trend(self, df: pd.DataFrame, i: int) -> str:
        try:
            ...
            logging.exception("❌ Error detecting trend")
            return 'sideways'
    ...
    def detect_bos(self, df: pd.DataFrame, i: int, direction: str) -> bool:
        try:
            ...
            logging.exception("❌ Error detecting BOS")
            return False
    ...
    def detect_rejection_candle(self, df: pd.DataFrame, i: int, direction: str) -> bool:
        try:
            ...
            logging.exception("❌ Error detecting rejection candle")
            return False
    ...
    def detect_trade_signal(self) -> Optional[Dict]:
        try:
            ...
            risk_reward = random.uniform(1.5, 2.0)
            ...
            logging.exception("❌ Error during trade signal detection")
            return None
    ...
    try:
        ...
        if signal:
            ...
            try:
                ...
                logging.exception("❌ Error saving signal to last_signal.json")
        else:
